...
class GraphvizTree():
    def __init__(self,tree_string, pop_index, tree_index, root_dir):
        ...
        dot.render(filename="{}/../data/trees/tree_".format(root_dir) + str(pop_index) + "_" + str(tree_index) , view=False)
